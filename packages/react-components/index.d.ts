...
const _default: ({ className, theme: _theme, item }: IPriceProps) => JSX.Element;
export default _default;
...
const _default: ({ className, price, theme, currency, hasDiscount, hasCompare, oldPrice, }: IPriceProps) => JSX.Element;
export default _default;
...
const _default: ({ value, count, theme, className }: IRatingProps) => JSX.Element;
export default _default;
...
/// <reference types="react" />
const _default: ({ theme, item, config }: {
    theme: any;
    item: any;
    config: any;
}) => JSX.Element;
...
const _default: ({ item, config, theme, className, Container }: IProductCardProps) => JSX.Element;
export default _default;
...
const _default: ({ children: _children, theme: _theme, columns: _columns, gutter: _gutter, className, style, wrapperComponent: WrapperComponent, columnComponent, ...rest }: IGridProps) => JSX.Element;
export default _default;
 ...
 */
export const getComponent: (type: FilterType) => import("react").ComponentClass<unknown, any>;
const _default: import("react").ComponentClass<any, any>;
export default _default;
...
const Icon: ({ name, component, className, ...rest }: IIconProps) => React.DetailedReactHTMLElement<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>;
export default Icon;
...
const LazyResultsView: ({ items, config, theme, card, onLoadNext, onLoadPrev, displayNextButton, displayPrevButton, ...rest }: ILazyResultsProps) => JSX.Element;
...
const TextView: ({ component, className, children, mode, theme, bold, style, inlineBlock, size, html: __html, }: ITextProps) => import("react").ReactElement<any, string | ((props: any) => import("react").ReactElement<any, any> | null) | (new (props: any) => import("react").Component<any, any, any>)>;
...
const _default: (BaseComponent: any) => {
    new (props: {} | Readonly<{}>): {
        ...
        render(): import("react").CElement<unknown, Component<unknown, any, any>> | null;
        context: any;
        setState<K extends never>(state: {} | ((prevState: Readonly<{}>, props: Readonly<{}>) => {} | Pick<{}, K> | null) | Pick<{}, K> | null, callback?: (() => void) | undefined): void;
        forceUpdate(callback?: (() => void) | undefined): void;
        readonly props: Readonly<{}> & Readonly<{
...
/// <reference types="react" />
const _default: (events?: any) => (BaseComponent: any) => (props: any) => import("react").CElement<any, import("react").Component<any, any, any>>;
export default _default;
