...
export default async () => {
  const { default: Search } = await import(/* webpackMode:"weak" */'@findify/react-components/src/layouts/Search');
  const { default: ZeroResults } = await import(/* webpackMode:"weak" */'@findify/react-components/src/layouts/Search');
