...
export default class NumericInput extends React.Component {
      ...
      if (e.keyCode === KEYCODE_UP) {
        ...
        if (e.keyCode === 8) {
          ...
          if (
            ...
            value.length &&
            value.charAt(this.input.selectionEnd - 1) === '.'
          ) {
            e.preventDefault();
            this.input.selectionStart = this.input.selectionEnd =
          ...
          if (
            this.input.selectionStart == this.input.selectionEnd &&
            this.input.selectionEnd < length + 1 &&
            value.length &&
            value.charAt(this.input.selectionEnd) === '.'
          ) {
            e.preventDefault();
            this.input.selectionStart = this.input.selectionEnd =
              this.input.selectionEnd + 1;
  ...
  render() {
      ...
      btnUp: {
        ...
        style: Object.assign(
          ...
          props.disabled
            ...
            : state.btnUpActive
              ? css['btn:active']
              : state.btnUpHover ? css['btn:hover'] : {},
        ),
      },
      btnDown: {
        onMouseEnter: undefined,
        ...
        style: Object.assign(
          ...
          props.disabled
            ...
            : state.btnDownActive
              ? css['btn:active']
              : state.btnDownHover ? css['btn:hover'] : {},
        ),
      },
    };
    ...
    return (
      <span {...attrs.wrap}>
        <input {...attrs.input} ref={r => r && (this.input = r)} />
        <b {...attrs.btnUp}>
          <i />
        </b>
        <b {...attrs.btnDown}>
